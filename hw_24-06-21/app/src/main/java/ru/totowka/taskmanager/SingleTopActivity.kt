...
class SingleTopActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        private const val ON_NEW_INTENT_MESSAGE =
            "Current: Single Top Activity.\nAlready existed, called OnNewIntent()"
        private const val MESSAGE = "Current: Single Top Activity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(LOG_TAG, "Single Top Activity №$single_top_id onCreate()")
        printTask()
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d(LOG_TAG, "Single Top Activity №$single_top_id onSaveInstanceState()")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Log.d(LOG_TAG, "Single Top Activity №$single_top_id onRestoreInstanceState()")
