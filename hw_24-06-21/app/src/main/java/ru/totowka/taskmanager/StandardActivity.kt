...
class StandardActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        private const val ON_NEW_INTENT_MESSAGE =
            "Standard Activity already existed, called OnNewIntent()"
        private const val MESSAGE = "Current: Standard Activity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        standard_id = intent.getIntExtra("standard_id", 1)
        ...
        Log.d(LOG_TAG, "Standard Activity №$standard_id onCreate()")
        printTask()
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d(LOG_TAG, "Standard Activity №$standard_id onSaveInstanceState()")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Log.d(LOG_TAG, "Standard Activity №$standard_id onRestoreInstanceState()")
