...
class SingleInstanceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        private const val ON_NEW_INTENT_MESSAGE =
            "Current: Single Instance Activity.\nAlready existed, called OnNewIntent()"
        private const val MESSAGE = "Current: Single Instance Activity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(LOG_TAG, "Single Instance Activity №$single_instance_id onCreate()")
        printTask()
    }

    private fun printTask() {
        findViewById<TextView>(R.id.description).text = MESSAGE + "\nID: №$single_instance_id"
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d(LOG_TAG, "Single Instance Activity №$single_instance_id onSaveInstanceState()")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Log.d(LOG_TAG, "Single Instance Activity №$single_instance_id onRestoreInstanceState()")
    ...
    private fun putData(
        ...
        return intent.apply {
            putExtra("standard_id", standard_id)
            putExtra("single_instance_id", single_instance_id)
            putExtra("single_task_id", single_task_id)
            putExtra("single_top_id", single_top_id)
        }
    }
}